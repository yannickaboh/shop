...
<head>
        ...
        <title>{{ $app_name ? $app_name : 'Shop 242' }}</title>
				...
				<div class="container">
					<nav id="navigation" class="navigation navigation-landscape">
						<div class="nav-header">
							<a class="nav-brand static-logo" href="#"><img src="{{ URL::to('shop/assets/img/logo-light.png') }}" class="logo" alt=""></a>
							<a class="nav-brand fixed-logo" href="#"><img src="{{ URL::to('shop/assets/img/logo.png') }}" class="logo" alt=""></a>
